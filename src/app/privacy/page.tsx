  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 font-mono">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="bg-gray-800 border-4 border-green-500 rounded-lg p-4 sm:p-6 lg:p-8 shadow-[8px_8px_0px_#22C55E]">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-green-400 mb-4 sm:mb-6 text-center tracking-wider">
            Privacy Policy
          </h1>
          <p className="text-center text-gray-400 mb-6 sm:mb-8 text-sm sm:text-base">Last Updated: August 11, 2025</p>
          ...
          <div className="space-y-6 sm:space-y-8 text-sm sm:text-base text-gray-300 leading-relaxed">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">1. Information We Collect</h2>
              <p>
                To enhance your experience on our site, we collect the following information:
              </p>
              <ul className="list-disc list-inside mt-2 pl-2 sm:pl-4 space-y-1 text-gray-400 text-sm sm:text-base">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">2. How We Use Your Information</h2>
              <p>
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">3. Data Storage and Security</h2>
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">4. Data Sharing</h2>
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">5. Third-Party Services</h2>
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">6. Your Data Rights</h2>
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">7. Children's Privacy</h2>
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">8. Changes to This Policy</h2>
                <p>We may update this privacy policy from time to time. We will notify you of any changes by posting the new policy on this page.</p>
            </div>

            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-green-300 mb-2 sm:mb-3">9. Contact Us</h2>
